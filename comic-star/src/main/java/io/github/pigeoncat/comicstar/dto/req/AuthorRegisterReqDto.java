...
public class AuthorRegisterReqDto {
     ...
     * QQ账号
     */
    @Schema(description = "QQ账号", required = true)
    @NotBlank(message = "QQ账号不能为空！")
    @Pattern(regexp = "^[1-9][0-9]{4,10}$", message = "QQ账号格式不正确！")
    private String qqAccount;

    /**
     * 微信账号
     */
    @Schema(description = "微信账号", required = true)
    @NotBlank(message = "微信账号不能为空！")
    @Pattern(regexp = "^[a-zA-Z]([-_a-zA-Z0-9]{5,19})+$", message = "微信账号格式不正确！")
