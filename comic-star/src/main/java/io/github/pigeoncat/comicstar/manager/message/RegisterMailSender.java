...
import io.github.pigeoncat.comicstar.core.config.MailProperties;
...
public class RegisterMailSender extends AbstractMailSender {
    ...
    protected String resolveContent(String content, Object... args) {
        ...
        String websiteLink = "https://www.pigeoncat.com";
        String websiteEmail = "3580341883@qq.com";
