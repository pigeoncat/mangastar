...
public class SystemConfigConsts {
     ...
     * 前台门户系统标识
     */
    public static final String COMICSTAR_FRONT_KEY = "front";

    /**
     * 作家管理系统标识
     */
    public static final String COMICSTAR_AUTHOR_KEY = "author";

    /**
     * 后台管理系统标识
     */
    public static final String COMICSTAR_ADMIN_KEY = "admin";
