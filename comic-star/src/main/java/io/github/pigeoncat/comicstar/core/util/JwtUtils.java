package io.github.pigeoncat.comicstar.core.util;
 ...
 *
 */
//当配置文件属性comicstar.jwt.secret存在时，加载以下组件
@ConditionalOnProperty("comicstar.jwt.secret")
@Component
@Slf4j
